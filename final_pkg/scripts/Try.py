...
class TaskServer(object):
    ...
    def __init__(self, name):
        ...
        self.gripper_service = rospy.ServiceProxy('/gripper', SetBool)
    ...
    def execute_cb(self, goal):
        ...
        try:
            ...
            rospy.sleep(0.2)  # Wait for 2 seconds
        ...
        if success:
            ...
            try:
                response = self.gripper_service.call(True) # Set the gripper state to True
                if response.success:
            ...
            try:
                ...
                if success:
                    ...
                    if One_Flag:
                        rospy.loginfo("Calling ROS service to control the gripper")
                        try:
                            response = self.gripper_service.call(False) # Set the gripper state to True
                            if response.success:
                                rospy.loginfo("Successfully controlled the gripper")
...
#         try:
#             response = self.gripper_service(state)
#             return response
#         except rospy.ServiceException as e:
#             rospy.logerr("Service call failed: %s" % e)
